        ...
        for(int i=0;i<100;i++){
            ...
            switch (MethodSelector){
                case 0:
                        ...
                        assertEquals("Error in addFirst,student is "+actual+",correct is "+expect,expect,actual);
                        break;
                ...
                case 1:
                        ...
                        assertEquals("Error in addFirst,student is "+actual1+",correct is "+expect1,expect1,actual1);
                        break;

                case 2:
                    Integer expect2=solution.size() > 0 ? solution.removeFirst() : null;
                    Integer actual2=student.size() > 0 ? solution.removeFirst() : null;
                    assertEquals("Error in removeFirst,student is "+actual2+",correct is "+expect2,expect2,actual2);
                    break;

                case 3:
                    Integer expect3=solution.size() > 0 ? solution.removeLast() : null;
                    Integer actual3=student.size() > 0 ? solution.removeLast() : null;
                    assertEquals("Error in removeLast,student is "+actual3+",correct is "+expect3,expect3,actual3);
                    break;
